...
PlaylistItems playlistItemsFromJson(String str) => PlaylistItems.fromJson(json.decode(str));
...
class ContentDetails {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "videoPublishedAt": videoPublishedAt == null ? null : videoPublishedAt.toIso8601String(),
  };
}
...
class Snippet {
  ...
  factory Snippet.fromJson(Map<String, dynamic> json) => Snippet(
    ...
    videoOwnerChannelTitle: json["videoOwnerChannelTitle"] == null ? null : json["videoOwnerChannelTitle"],
    videoOwnerChannelId: json["videoOwnerChannelId"] == null ? null : json["videoOwnerChannelId"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "videoOwnerChannelTitle": videoOwnerChannelTitle == null ? null : videoOwnerChannelTitle,
    "videoOwnerChannelId": videoOwnerChannelId == null ? null : videoOwnerChannelId,
  };
}
