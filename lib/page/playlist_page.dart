...
class DetailPlaylist extends StatefulWidget {
  ...
  DetailPlaylist({this.id, this.imgChannel});

  @override
  _DetailPlaylistState createState() => _DetailPlaylistState();
}
      ...
      child: Scaffold(
          ...
          body: Stack(
            children: [
              ...
              FutureBuilder<PlaylistItems>(
                future: FetchApi.fetchPlaylistItems(playlistId: widget.id),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: snapshot.data.items[0]
